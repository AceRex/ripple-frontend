    ...
    <section className="py-24">
      ...
      <div className="w-[90%] m-auto relative">
        <div className="min-[768px]:flex max-[680px]:block max-[680px]:m-auto max-[768px]:w-[45%] min-[768px]:w-[90%] m-auto z-10 justify-between">
          <div className=" rounded-[3.2rem] m-auto overflow-hidden max-[680px]:m-auto min-[768px]:mr-44">
            {currentView === "view1" ? (
              <img
                src={Onboarding}
          ...
          {/* circle */}
          <div className="max-[680px]:hidden rounded-full -z-10 p-[30px] min-[768px]:block min-[1536px]:block border-2 border-primary left-20 top-7 absolute">
          ...
          <ul className="max-[768px]:block hidden">
            <li className="mb-10 grid grid-cols-4 gap-4">
              <p
                className={
                  currentView === "view1"
